...
class VuePygame:
    ...
    def dessiner_environnement(self, environnement):
        ...
        if robot.cooldown_degats > 0 and int(robot.cooldown_degats * 10) % 2 == 0:
    ...
    def dessiner_hud(self, environnement):
        ...
        aide = self.small_font.render(
            "Flèches/ZQSD : bouger | Espace : tirer | 1/2/3 : choix upgrade | R : recommencer",
            True,
            (60, 60, 60)
        )
        ...
        if environnement.game_over:
            ...
            texte2 = self.font.render("Appuie sur R pour recommencer", True, (255, 255, 255))
    ...
    def dessiner_menu_upgrade(self, environnement):
        ...
        pygame.draw.rect(
            self.screen,
            (245, 245, 245),
            (boite_x, boite_y, boite_largeur, boite_hauteur),
            border_radius=18
        )
        pygame.draw.rect(
            self.screen,
        ...
        for i, (_, label) in enumerate(environnement.choix_ameliorations):
            ...
            pygame.draw.rect(
                self.screen,
                (220, 220, 220),
                (boite_x + 40, yy, 480, 45),
                border_radius=10
            )
            self.screen.blit(texte, (boite_x + 60, yy + 10))

        aide = self.small_font.render("Appuie sur 1, 2 ou 3", True, (70, 70, 70))
        self.screen.blit(aide, (boite_x + 190, boite_y + 275))
